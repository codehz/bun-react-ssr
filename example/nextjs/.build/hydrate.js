...
// ../../router/utils/get-route-matcher.ts
...
var parseParameter = function(param) {
...
var getParametrizedRoute = function(route) {
...
var getRouteRegex = function(normalizedRoute) {
...
var getRouteMatcherFunc = function(routeRegex) {
...
function useRouteState(key, initial) {
  return import_react2.useReducer((_old, newvalue) => {
...
function useLocationProperty(fn, ssrFn) {
  return import_react2.useSyncExternalStore(subscribeToLocationUpdates, fn, ssrFn);
}
...
var VersionContext = import_react2.createContext(0);
var useLoadingVersion = () => import_react2.useContext(VersionContext);
var useLoadingEffect = (effect, deps = []) => {
  import_react2.useEffect(effect, [import_react2.useContext(VersionContext), ...deps]);
};
var useReloadEffect = (effect, deps = []) => {
  const [once, setOnce] = import_react2.useState(true);
  import_react2.useEffect(() => {
    ...
    return effect();
  }, [import_react2.useContext(VersionContext), ...deps]);
};
var ReloadContext = import_react2.createContext(async () => {
});
var RouterHost = ({
  children,
  ...
  const [current, setCurrent] = import_react2.useState(children);
  const [version, setVersion] = import_react2.useState(0);
  const versionRef = import_react2.useRef(version);
  const reload = import_react2.useCallback(async (target = location.pathname + location.search) => {
    ...
    if (currentVersion === versionRef.current) {
      if (props?.redirect) {
        ...
        import_react2.startTransition(() => {
          onRouteUpdated?.(target);
          setVersion(currentVersion);
          setCurrent(jsx_dev_runtime2.jsxDEV(Shell, {
            route: target,
            ...props,
            children: jsx_dev_runtime2.jsxDEV(module.default, {
              ...props?.props
  ...
  return jsx_dev_runtime2.jsxDEV(ReloadContext.Provider, {
    value: reload,
    children: jsx_dev_runtime2.jsxDEV(VersionContext.Provider, {
      value: version,
      children: current
    }, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
...
async function hydrate(Shell, {
  ...
  const matched = match2(globalX2.__INITIAL_ROUTE__.split("?")[0]);
  const Initial = await import(matched.value);
  let JsxToDisplay = jsx_dev_runtime3.jsxDEV(Initial.default, {
    ...globalX2.__SERVERSIDE_PROPS__?.props
  }, undefined, false, undefined, this);
  switch (globalX2.__DISPLAY_MODE__) {
    case "nextjs":
  ...
  return client.hydrateRoot(document, jsx_dev_runtime3.jsxDEV(RouterHost, {
    Shell,
    ...options,
    children: jsx_dev_runtime3.jsxDEV(Shell, {
      route: globalX2.__INITIAL_ROUTE__,
      ...globalX2.__SERVERSIDE_PROPS__,
...
async function NextJsLayoutStacker({
  ...
  let currentJsx = jsx_dev_runtime3.jsxDEV(jsx_dev_runtime3.Fragment, {}, undefined, false, undefined, this);
...
"use client";
var globalX2 = globalThis;
var match2 = getRouteMatcher(globalX2.__ROUTES__);

// shell.tsx
var jsx_dev_runtime4 = __toESM(require_jsx_dev_runtime(), 1);
var ExampleShell = ({
  children
}) => jsx_dev_runtime4.jsxDEV("html", {
  children: [
    jsx_dev_runtime4.jsxDEV("head", {
      children: jsx_dev_runtime4.jsxDEV("title", {
        children: "Example"
      }, undefined, false, undefined, this)
    }, undefined, false, undefined, this),
    jsx_dev_runtime4.jsxDEV("body", {
      children
    }, undefined, false, undefined, this)
  ]
